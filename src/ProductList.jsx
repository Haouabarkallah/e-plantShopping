...
function ProductList({ onHomeClick }) {
    ...
    const plantsArray = [
        ...
        // ... rest of your categories (Insect Repellent, Medicinal, Low Maintenance) remain here
    ];
    ...
    const handleAddToCart = (product) => {
        dispatch(addItem(product)); // Using the addItem action via dispatch
                    ...
                    <div> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                {/* Displaying the live quantity badge over or next to the icon */}
